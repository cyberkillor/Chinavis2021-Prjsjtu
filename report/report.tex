...
对于heatmap组件，其可视范围可根据实际效果进行设定；而对于具体的热力点，其半径同样可以根据实际需求进行设定
    ...
    \begin{figure}[h!]
        \centering
        \subfloat[2013年5月热力图]{\includegraphics[width=0.3\columnwidth]{images/time_space1.png}}
        \subfloat[2013年6月热力图]{\includegraphics[width=0.3\columnwidth]{images/time_space2.png}}
        \subfloat[2013年7月热力图]{\includegraphics[width=0.3\columnwidth]{images/time_space3.png}}
