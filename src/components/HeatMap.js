const HeatMap = () => {
    ...
    return (
        <div>
            ...
            <div className="input-card" style={{width: 20}}>
                <div className="input-item">
                    <button className="btn-hm" onClick="heatmap.show()">显示热力图</button>
                </div>
                <div className="input-item">
                    <button className="btn-hm" onClick="heatmap.hide()">关闭热力图</button>
            </div>
            </div>
        </div>
    )
